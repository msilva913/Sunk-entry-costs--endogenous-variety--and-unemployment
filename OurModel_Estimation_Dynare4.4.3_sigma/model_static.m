...
residual(11)= lhs-rhs;
lhs =y(12);
rhs =(params(6)-1)*y(4)*exp(y(27))/params(6);
residual(12)= lhs-rhs;
lhs =y(13);
...
residual(26)= lhs-rhs;
lhs =y(27);
rhs =y(27)*params(7)+(1-params(7))*(y(27))-params(10)*x(1);
residual(27)= lhs-rhs;
lhs =y(28);
rhs =y(28)*params(8)+(1-params(8))*(y(28))+params(11)*x(2);
residual(28)= lhs-rhs;
lhs =y(29);
rhs =y(29)*params(9)+(1-params(9))*(y(29))-params(12)*x(3);
residual(29)= lhs-rhs;
lhs =y(30);
...
if nargout >= 2,
  ...
  g1(7,6)=1-T50;
  g1(7,7)=(-T50);
  g1(7,28)=(-((y(6)+y(7))*y(5)*params(13)*(-exp(y(28)))/y(5)));
  g1(8,8)=1;
  ...
  g1(9,12)=(-T68);
  g1(9,13)=T68;
  g1(9,28)=(-((y(12)-y(13)-y(9)+(params(18)+y(9)/y(3))*(1-exp(y(29))))*y(5)*params(13)/y(5)*(-exp(y(28)))));
  g1(9,29)=(-(T68*(params(18)+y(9)/y(3))*(-exp(y(29)))));
  g1(10,9)=1;
  g1(10,10)=(-(1-T68));
  g1(10,28)=y(10)*y(5)*params(13)/y(5)*(-exp(y(28)));
  g1(11,10)=1;
  g1(11,11)=(-(1/params(19)*getPowerDeriv(T86,params(4),1)));
  g1(12,4)=(-((params(6)-1)*exp(y(27))/params(6)));
  g1(12,12)=1;
  g1(12,27)=(-((params(6)-1)*y(4)*exp(y(27))/params(6)));
  ...
  g1(29,29)=1-(params(9)+1-params(9));
