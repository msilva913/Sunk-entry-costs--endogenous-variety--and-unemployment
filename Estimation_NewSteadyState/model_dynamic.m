...
T328 = (1-y(11))*y(1)+y(41)*(1-y(69))+(1-y(22))*y(23);
T452 = (-(params(16)*(1-y(69))*y(106)))/(y(44)*y(44));
T470 = (-(1/(y(47)+y(3)+y(24))));
T506 = (-(0.3333333333333333/(0.3333333333333333*(y(54)+y(5)+y(19)))));
T514 = (-(0.3333333333333333/(0.3333333333333333*(y(55)+y(6)+y(20)))));
T521 = (-(1/(y(7)+y(56)+y(21))));
T540 = (-(0.3333333333333333/(0.3333333333333333*(y(66)+y(8)+y(25)))));
T570 = (-(1/(y(69)+y(11)+y(22))));
lhs =y(40);
rhs =y(55)/y(54);
residual(1)= lhs-rhs;
lhs =y(41);
...
residual(14)= lhs-rhs;
lhs =y(54);
rhs =(1-(1-y(11))*y(1))*y(5)+y(7)*(1-y(5));
residual(15)= lhs-rhs;
lhs =y(55);
...
residual(30)= lhs-rhs;
lhs =y(70);
rhs =log(0.3333333333333333*(y(54)+y(5)+y(19)));
residual(31)= lhs-rhs;
lhs =y(71);
rhs =log(0.3333333333333333*(y(55)+y(6)+y(20)));
residual(32)= lhs-rhs;
lhs =y(72);
rhs =log(y(7)+y(56)+y(21));
residual(33)= lhs-rhs;
lhs =y(73);
rhs =log(T328);
residual(34)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(3,42)=1;
  g1(4,43)=1;
  g1(4,53)=(-(getPowerDeriv(y(53),params(14),1)));
  g1(5,44)=1;
  g1(5,61)=(-(getPowerDeriv(y(61),(-params(1)),1)));
  g1(6,44)=(-((y(107)+y(108))*T452));
  ...
  g1(33,21)=T521;
  g1(34,1)=(-((1-y(11))/T328));
  g1(34,41)=(-((1-y(69))/T328));
  g1(34,11)=(-((-y(1))/T328));
  g1(34,69)=(-((-y(41))/T328));
  g1(34,73)=1;
  g1(34,22)=(-((-y(23))/T328));
  g1(34,23)=(-((1-y(22))/T328));
  g1(35,11)=T570;
  g1(35,69)=T570;
  g1(35,74)=1;
  g1(35,22)=T570;
