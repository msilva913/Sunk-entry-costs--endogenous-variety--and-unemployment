...
// Group 5: laws of motion
    ...
    [name='LOM of firms']
    N = (1-delta(-1))*(N(-1)+Ne(-1));
    
    [name='LOM of unemployment']
    u = (1-(1-delta(-1))*f(-1))*u(-1) + tau(-1)*(1-u(-1));
