...
T93 = y(43)/params(19);
T105 = y(33)/T47;
T427 = (-(1/(y(40)+y(3)+y(20))));
T461 = (-(0.3333333333333333/(0.3333333333333333*(y(47)+y(5)+y(16)))));
T469 = (-(0.3333333333333333/(0.3333333333333333*(y(48)+y(6)+y(17)))));
lhs =y(33);
rhs =y(48)/y(47);
residual(1)= lhs-rhs;
lhs =y(34);
...
residual(31)= lhs-rhs;
lhs =y(64);
rhs =log(0.3333333333333333*(exp(y(58))+exp(y(7))+exp(y(18))));
residual(32)= lhs-rhs;
lhs =y(65);
...
if nargout >= 2,
  ...
  g1(31,62)=(-1);
  g1(31,63)=1;
  g1(32,7)=(-(0.3333333333333333*exp(y(7))/(0.3333333333333333*(exp(y(58))+exp(y(7))+exp(y(18))))));
  g1(32,58)=(-(exp(y(58))*0.3333333333333333/(0.3333333333333333*(exp(y(58))+exp(y(7))+exp(y(18))))));
  g1(32,64)=1;
  g1(32,18)=(-(0.3333333333333333*exp(y(18))/(0.3333333333333333*(exp(y(58))+exp(y(7))+exp(y(18))))));
