...
residual(1)= lhs-rhs;
lhs =y(36);
rhs =params(16)*y(35)^(1-params(13));
residual(2)= lhs-rhs;
lhs =y(37);
rhs =params(16)*y(35)^(-params(13));
residual(3)= lhs-rhs;
lhs =y(38);
rhs =y(48)^(1/(params(5)-1));
residual(4)= lhs-rhs;
lhs =y(39);
rhs =y(55)^(-params(14));
residual(5)= lhs-rhs;
lhs =y(40);
rhs =(params(5)-1)*y(38)*params(17)/params(5);
residual(6)= lhs-rhs;
lhs =y(40);
rhs =params(12)*T47*y(94)/y(39)*(y(95)+y(96));
residual(7)= lhs-rhs;
lhs =y(42);
...
residual(11)= lhs-rhs;
lhs =y(46);
rhs =(params(5)-1)*y(38)*exp(y(61))/params(5);
residual(12)= lhs-rhs;
lhs =y(47);
rhs =params(20)*(y(46)-y(43)+T105*(y(43)+y(37)*params(18)))+(1-params(20))*params(1)*(steady_state(13));
residual(13)= lhs-rhs;
lhs =y(48);
rhs =T47*(y(4)+y(3));
residual(14)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,50)=(-(1/y(49)));
  g1(2,35)=(-(params(16)*getPowerDeriv(y(35),1-params(13),1)));
  g1(2,36)=1;
  g1(3,35)=(-(params(16)*getPowerDeriv(y(35),(-params(13)),1)));
  g1(3,37)=1;
  g1(4,38)=1;
  g1(4,48)=(-(getPowerDeriv(y(48),1/(params(5)-1),1)));
  g1(5,39)=1;
  g1(5,55)=(-(getPowerDeriv(y(55),(-params(14)),1)));
  g1(6,38)=(-((params(5)-1)*params(17)/params(5)));
  g1(6,40)=1;
  g1(7,39)=(-((y(95)+y(96))*(-(params(12)*T47*y(94)))/(y(39)*y(39))));
  g1(7,94)=(-((y(95)+y(96))*params(12)*T47/y(39)));
  g1(7,40)=1;
  g1(7,95)=(-(params(12)*T47*y(94)/y(39)));
  g1(7,96)=(-(params(12)*T47*y(94)/y(39)));
  g1(7,62)=(-((y(95)+y(96))*y(94)*params(12)*(-exp(y(62)))/y(39)));
  g1(8,42)=1;
  g1(8,52)=(-(exp(y(61))/params(17)));
  g1(8,61)=(-(y(52)*exp(y(61))/params(17)));
  g1(9,37)=(-y(43))/(y(37)*y(37));
  g1(9,93)=(-(T70*(1-exp(y(63)))*(-y(97))/(y(93)*y(93))));
  g1(9,39)=(-(T83*T47*(-(params(12)*y(94)))/(y(39)*y(39))));
  g1(9,94)=(-(T83*T47*params(12)/y(39)));
  g1(9,43)=1/y(37);
  g1(9,97)=(-(T70*((-1)+(1-exp(y(63)))*1/y(93))));
  g1(9,99)=(-T70);
  g1(9,100)=T70;
  g1(9,62)=(-(T83*params(12)*y(94)/y(39)*(-exp(y(62)))));
  g1(9,63)=(-(T70*(params(18)+y(97)/y(93))*(-exp(y(63)))));
  g1(10,39)=y(98)*T47*(-(params(12)*y(94)))/(y(39)*y(39));
  g1(10,94)=y(98)*T47*params(12)/y(39);
  g1(10,43)=1;
  g1(10,44)=(-1);
  g1(10,98)=T70;
  g1(10,62)=y(98)*params(12)*y(94)/y(39)*(-exp(y(62)));
  g1(11,44)=1;
  g1(11,45)=(-(1/params(19)*getPowerDeriv(T93,params(3),1)));
  g1(12,38)=(-((params(5)-1)*exp(y(61))/params(5)));
  g1(12,46)=1;
  g1(12,61)=(-((params(5)-1)*y(38)*exp(y(61))/params(5)));
  ...
  g1(20,45)=(-(params(19)/(1+params(3))*1/params(19)*getPowerDeriv(T93,1+params(3),1)));
  g1(20,54)=1;
