...
residual(28)= lhs-rhs;
lhs =y(29);
rhs =0.3333333333333333*(y(15)+y(15)+y(41));
residual(29)= lhs-rhs;
lhs =y(30);
rhs =0.3333333333333333*(y(16)+y(16)+y(42));
residual(30)= lhs-rhs;
lhs =y(31);
rhs =y(30)/y(29);
residual(31)= lhs-rhs;
...
residual(32)= lhs-rhs;
lhs =y(33);
rhs =0.3333333333333333*(exp(y(28))+exp(y(28))+exp(y(44)));
residual(33)= lhs-rhs;
lhs =y(34);
rhs =(y(8)+y(8)+y(45))/(y(14));
residual(34)= lhs-rhs;
lhs =y(35);
rhs =y(47);
residual(35)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(29,15)=(-0.6666666666666666);
  g1(29,29)=1;
  g1(29,41)=(-0.3333333333333333);
  g1(30,16)=(-0.6666666666666666);
  g1(30,30)=1;
  g1(30,42)=(-0.3333333333333333);
  g1(31,29)=(-((-y(30))/(y(29)*y(29))));
  g1(31,30)=(-(1/y(29)));
  g1(31,31)=1;
  g1(32,26)=(-(0.3333333333333333*(exp(y(26))+exp(y(26)))));
  g1(32,32)=1;
  g1(32,43)=(-(0.3333333333333333*exp(y(43))));
  g1(33,28)=(-(0.3333333333333333*(exp(y(28))+exp(y(28)))));
  g1(33,33)=1;
  g1(33,44)=(-(0.3333333333333333*exp(y(44))));
  g1(34,8)=(-(2/(y(14))));
  g1(34,14)=(-((-(y(8)+y(8)+y(45)))/((y(14))*(y(14)))));
  g1(34,34)=1;
  g1(34,45)=(-(1/(y(14))));
  g1(35,35)=1;
  g1(35,47)=(-1);
