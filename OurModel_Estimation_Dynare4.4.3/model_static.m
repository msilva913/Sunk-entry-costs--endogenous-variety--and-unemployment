...
T47 = 1-exp(y(27));
T50 = y(5)*params(13)*T47/y(5);
T68 = T47*y(5)*params(13)/y(5);
T86 = y(11)/params(19);
T96 = y(1)/T47;
lhs =y(1);
rhs =y(16)/y(15);
residual(1)= lhs-rhs;
lhs =y(2);
rhs =params(16)*y(1)^(1-params(14));
residual(2)= lhs-rhs;
lhs =y(3);
rhs =params(16)*y(1)^(-params(14));
residual(3)= lhs-rhs;
lhs =y(4);
rhs =y(14)^(1/(params(6)-1));
residual(4)= lhs-rhs;
lhs =y(5);
rhs =y(21)^(-params(1));
residual(5)= lhs-rhs;
lhs =y(6);
rhs =(params(6)-1)*y(4)*params(17)/params(6);
residual(6)= lhs-rhs;
lhs =y(6);
rhs =T50*(y(6)+y(7));
residual(7)= lhs-rhs;
...
residual(11)= lhs-rhs;
lhs =y(12);
rhs =(params(6)-1)*y(4)*exp(y(26))/params(6);
residual(12)= lhs-rhs;
lhs =y(13);
rhs =params(20)*(y(12)-y(9)+T96*(y(9)+y(3)*params(18)))+(1-params(20))*params(2)*(y(13));
residual(13)= lhs-rhs;
lhs =y(14);
rhs =T47*(y(14)+y(8));
residual(14)= lhs-rhs;
...
residual(19)= lhs-rhs;
lhs =y(20);
rhs =params(19)/(1+params(4))*T86^(1+params(4));
residual(20)= lhs-rhs;
lhs =y(22);
...
residual(25)= lhs-rhs;
lhs =y(26);
rhs =y(26)*params(7)+(1-params(7))*(y(26))-params(10)*x(1);
residual(26)= lhs-rhs;
lhs =y(27);
rhs =y(27)*params(8)+(1-params(8))*(y(27))+params(11)*x(2);
residual(27)= lhs-rhs;
lhs =y(28);
rhs =y(28)*params(9)+(1-params(9))*(y(28))-params(12)*x(3);
residual(28)= lhs-rhs;
lhs =y(29);
...
residual(31)= lhs-rhs;
lhs =y(32);
rhs =0.3333333333333333*(exp(y(26))+exp(y(26))+exp(y(43)));
residual(32)= lhs-rhs;
lhs =y(33);
...
if nargout >= 2,
  ...
  g1(1,16)=(-(1/y(15)));
  g1(2,1)=(-(params(16)*getPowerDeriv(y(1),1-params(14),1)));
  g1(2,2)=1;
  g1(3,1)=(-(params(16)*getPowerDeriv(y(1),(-params(14)),1)));
  g1(3,3)=1;
  g1(4,4)=1;
  g1(4,14)=(-(getPowerDeriv(y(14),1/(params(6)-1),1)));
  g1(5,5)=1;
  g1(5,21)=(-(getPowerDeriv(y(21),(-params(1)),1)));
  g1(6,4)=(-((params(6)-1)*params(17)/params(6)));
  g1(6,6)=1;
  g1(7,6)=1-T50;
  g1(7,7)=(-T50);
  g1(7,27)=(-((y(6)+y(7))*y(5)*params(13)*(-exp(y(27)))/y(5)));
  g1(8,8)=1;
  ...
  g1(9,12)=(-T68);
  g1(9,13)=T68;
  g1(9,27)=(-((y(12)-y(13)-y(9)+(params(18)+y(9)/y(3))*(1-exp(y(28))))*y(5)*params(13)/y(5)*(-exp(y(27)))));
  g1(9,28)=(-(T68*(params(18)+y(9)/y(3))*(-exp(y(28)))));
  g1(10,9)=1;
  g1(10,10)=(-(1-T68));
  g1(10,27)=y(10)*y(5)*params(13)/y(5)*(-exp(y(27)));
  g1(11,10)=1;
  g1(11,11)=(-(1/params(19)*getPowerDeriv(T86,params(4),1)));
  g1(12,4)=(-((params(6)-1)*exp(y(26))/params(6)));
  g1(12,12)=1;
  g1(12,26)=(-((params(6)-1)*y(4)*exp(y(26))/params(6)));
  g1(13,1)=(-(params(20)*(y(9)+y(3)*params(18))*1/T47));
  g1(13,3)=(-(params(20)*params(18)*T96));
  g1(13,9)=(-(params(20)*((-1)+T96)));
  g1(13,12)=(-params(20));
  g1(13,13)=1-(1-params(20))*params(2);
  ...
  g1(20,11)=(-(params(19)/(1+params(4))*1/params(19)*getPowerDeriv(T86,1+params(4),1)));
  g1(20,20)=1;
  ...
  g1(26,26)=1-(params(7)+1-params(7));
  g1(27,27)=1-(params(8)+1-params(8));
  g1(28,28)=1-(params(9)+1-params(9));
  ...
  g1(31,30)=(-1);
  g1(31,31)=1;
  g1(32,26)=(-(0.3333333333333333*(exp(y(26))+exp(y(26)))));
  g1(32,32)=1;
  g1(32,43)=(-(0.3333333333333333*exp(y(43))));
