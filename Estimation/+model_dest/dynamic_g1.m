...
g1 = zeros(40, 60);
g1(1,12)=1/y(19);
g1(1,52)=(-(T(3)*(T(5)*1/y(54)-1)));
g1(1,53)=T(3);
g1(1,19)=(-y(12))/(y(19)*y(19));
g1(1,54)=(-(T(3)*T(5)*(-y(52))/(y(54)*y(54))));
g1(1,55)=(-T(3));
g1(1,29)=(-(T(17)*T(2)*(-(params(1)*y(58)))/(y(29)*y(29))));
g1(1,58)=(-(T(17)*T(2)*params(1)/y(29)));
g1(1,37)=(-(T(17)*params(1)*y(58)/y(29)*(-(params(2)*exp(y(37))))));
...
g1(5,51)=T(3);
g1(5,12)=1;
g1(5,29)=y(51)*T(2)*(-(params(1)*y(58)))/(y(29)*y(29));
g1(5,58)=y(51)*T(2)*params(1)/y(29);
g1(5,37)=y(51)*params(1)*y(58)/y(29)*(-(params(2)*exp(y(37))));
g1(6,15)=(-(1/y(16)));
...
g1(12,29)=1;
g1(13,24)=1;
g1(13,56)=(-(y(58)*params(1)*T(2)/y(29)));
g1(13,57)=(-(y(58)*params(1)*T(2)/y(29)));
g1(13,29)=(-((y(56)+y(57))*(-(y(58)*params(1)*T(2)))/(y(29)*y(29))));
g1(13,58)=(-((y(56)+y(57))*params(1)*T(2)/y(29)));
g1(13,37)=(-((y(56)+y(57))*y(58)*params(1)*(-(params(2)*exp(y(37))))/y(29)));
