...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(2,1)=3; nzij_pred(2,2)=5;
  nzij_pred(3,1)=10; nzij_pred(3,2)=7;
  nzij_current = zeros(19, 2, 'int32');
  nzij_current(1,1)=2; nzij_current(1,2)=1;
  nzij_current(2,1)=4; nzij_current(2,2)=2;
  nzij_current(3,1)=8; nzij_current(3,2)=2;
  nzij_current(4,1)=3; nzij_current(4,2)=3;
  nzij_current(5,1)=4; nzij_current(5,2)=3;
  ...
  nzij_current(17,1)=7; nzij_current(17,2)=8;
  nzij_current(18,1)=8; nzij_current(18,2)=9;
