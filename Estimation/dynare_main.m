...
%% Baseline model with endogenous business formation and sunk vacancy costs

dynare RBC_IRF_matching.mod 

dynare baseline.mod 
dynare model_dest.mod 

dynare flow_specification.mod

%dynare baseline_alt.mod

dynare baseline.mod 
dynare perfect_foresight.mod
%dynare baseline_est.mod

dynare baseline_u_growth_est.mod


%% Basic DMP model as benchmark
dynare DMP.mod
irfs = oo_.irfs
irfs.theta_imp_e_x
irfs.v_imp_e_x
irfs.u_imp_e_x
%% Basic Gabrovski-Silva model
%%
dynare GS_basic.mod
