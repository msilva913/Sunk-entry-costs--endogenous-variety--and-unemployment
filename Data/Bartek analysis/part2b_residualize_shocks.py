...
def _load_controls() -> pd.DataFrame:
    ...
    extended_label = " [GDP-anchored Chow-Lin extended]" if BEA_VA_CACHE == _BEA_VA_EXTENDED else " [FRED 2005Q1+ only]"
    print(f"\n--- Industry real value-added (BEA via FRED){extended_label} ---")
