...
The second set consists of empirically identified impulse responses from the
	...
	One might ask whether the IRF block is necessary at all: why not use the full
	structural likelihood on aggregate time series and omit the impulse responses
	entirely?  The answer is identification.  The full likelihood recovers structural
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\textcolor{red}{May need updating}\\
