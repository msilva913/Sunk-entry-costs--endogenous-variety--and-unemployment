...
# BLAS.vendor() 
# :mkl
""" Role of symbolic toolbox
Symbolic toolbox is used to obtain steady-state expressions and derivative matrices of each model in terms of parameters 
Store them as strings concatenated with lines
Parse these strings to convert them into Expr type objects
Prevents calling eval() function each step
"""
#########################################################################################################
# Functions #
#########################################################################################################
...
"""
Model simulation with inputs:
model: model object 
sol_mat: policy functions g and h 
TS: length of series
eta: array of shocks
SS: array of steady-state values 
flag_IR: dummy for impulse responses
flag_logdev: boolean for log deviations
"""
