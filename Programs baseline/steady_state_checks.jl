...
targets = (labor_share=0.66, dest_ann=0.06, r_ann=0.04, f =0.41, η_L=0.6, q=0.8, sep=0.031, b_ratio=0.71, x_v=0.2, ξ_inv=1, ε=4, σ=1.5, N=1, w=1.0)
cal = calibrate_labor_share(targets)

steady = steady_state(cal)
@unpack p, L_c, L_e, w, w_R, L, N, N_e, K, q, ν_f, d_f, C, Y, Y_c, X_v, X, labor_share, sunk_vac_cost_share, x_v, M = steady
...
targets2 = (labor_share=0.66, dest_ann=0.06, r_ann=0.04, f =0.41, η_L=0.6, q=0.8, sep=0.031, b_ratio=0.41, x_v=0.2, ξ_inv=1, ε=4, σ=1.5, N=1.0, w=1.0)
