...
Pkg.add([
    ...
    Pkg.PackageSpec(name="Plots", version="1.37.0"),
    Pkg.PackageSpec(name="GR", version="0.71.0"),
    ...
    Pkg.PackageSpec(name="GLM", version="1.8.0"),
    Pkg.PackageSpec(name="Pandas", version="1.6.1"),
])
