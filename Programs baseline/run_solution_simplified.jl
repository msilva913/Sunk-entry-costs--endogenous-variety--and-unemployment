...
# Variables
@syms  z δ s θ q u v v_pret K Q  N p
@syms zp δp sp θp qp up vp v_pretp Kp Qp Np pp
...
# Equilibrium conditions
    ...
    f[1]  =  κ + K/q - β*(Cp/C)^(-σ)*(1-δbar*δ)*((1-ϕ)*pp*zp/μ-ϕ*θ*(K+q*κ)+(1-sbar*sp)*(κ+Kp/qp))
...
#########################################################
# Alternate calibration: coparison with CK
