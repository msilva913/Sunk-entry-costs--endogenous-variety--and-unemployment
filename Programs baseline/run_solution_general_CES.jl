...
# Parameters
    @syms f_e zbar δbar sbar b ϕ ρ σ ε ζ A η_L F κ ξ_inv ρ_z σ_z ρ_δ σ_δ ρ_s σ_s
    parameters      = [f_e; zbar; δbar; sbar; b; ϕ; ρ; σ; ε; ζ; A; η_L; F; κ; ξ_inv; ρ_z; σ_z; ρ_δ; σ_δ; ρ_s; σ_s ]
    estimate        = []
    position        = []
    priors          = (;)
...
δbar = δ
sbar = s
PAR     =   [f_e; zbar; δbar; sbar; b; ϕ; ρ; σ; ε; ζ; A; η_L; F; κ; ξ_inv; ρ_z; σ_z; ρ_δ; σ_δ; ρ_s; σ_s ]
