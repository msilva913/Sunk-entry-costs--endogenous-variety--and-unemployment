...
if T_flag
    T = BGM_remove_variety_effects.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(19, 1);
    residual(1) = (T(1)) - (T(2)*(y(25)+y(24))/y(8));
    residual(2) = (y(15)) - (1.0);
    residual(3) = (y(4)) - (y(11)*1.0*y(21));
    residual(4) = (y(12)) - (y(10)-y(11));
    residual(5) = (y(9)) - (1.0*y(21)/(params(6)/(params(6)-1)));
    residual(6) = (y(10)) - ((T(1)*y(9)/params(4))^params(5));
    residual(7) = (y(8)) - (y(9)*params(7)/y(21));
    residual(8) = (y(7)) - (y(4)/(params(6)*y(6)));
    residual(9) = (y(4)+y(8)*y(5)) - (y(10)*y(9)+y(7)*y(6));
    residual(10) = (y(13)) - (y(4)+y(8)*y(5));
    residual(11) = (y(14)) - (y(13)/1.0);
