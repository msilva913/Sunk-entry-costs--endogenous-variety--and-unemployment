...
residual(29)= lhs-rhs;
lhs =y(30);
rhs =log(0.3333333333333333*(y(15)+y(15)+y(44)));
residual(30)= lhs-rhs;
lhs =y(31);
rhs =log(0.3333333333333333*(y(16)+y(16)+y(45)));
residual(31)= lhs-rhs;
lhs =y(32);
rhs =y(31)-y(30);
residual(32)= lhs-rhs;
lhs =y(33);
rhs =log(0.3333333333333333*(y(25)+y(25)+y(46)));
residual(33)= lhs-rhs;
lhs =y(34);
rhs =log(y(26)+y(26)+y(47));
residual(34)= lhs-rhs;
lhs =y(35);
rhs =log(exp(y(29))+exp(y(29))+exp(y(48)));
residual(35)= lhs-rhs;
lhs =y(36);
rhs =log(y(8)+y(8)+y(49));
residual(36)= lhs-rhs;
lhs =y(37);
rhs =y(51);
residual(37)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(7,6)=1-T50;
  g1(7,7)=(-T50);
  g1(7,29)=(-((y(6)+y(7))*y(5)*params(12)*(-exp(y(29)))/y(5)));
  g1(8,8)=1;
  ...
  g1(9,29)=(-((y(12)-y(13)-y(9)+(params(18)+y(9)/y(3))*(1-exp(y(28))))*y(5)*params(12)/y(5)*(-exp(y(29)))));
  g1(10,9)=1;
  g1(10,10)=(-(1-T68));
  g1(10,29)=y(10)*y(5)*params(12)/y(5)*(-exp(y(29)));
  g1(11,10)=1;
  ...
  g1(13,29)=(-(params(20)*(y(9)+y(3)*params(18))*(-(y(1)*(-exp(y(29)))))/(T47*T47)));
  g1(14,8)=(-T47);
  g1(14,14)=1-T47;
  g1(14,29)=(-((y(14)+y(8))*(-exp(y(29)))));
  g1(15,2)=(-(y(15)*(-T47)));
  g1(15,15)=1-(1-y(2)*T47-y(26));
  g1(15,26)=(-(1-y(15)));
  g1(15,29)=(-(y(15)*(-(y(2)*(-exp(y(29)))))));
  g1(16,3)=(-(T47*(-y(16))));
  g1(16,11)=(-1);
  g1(16,15)=(-(T47*(-exp(y(28)))));
  g1(16,16)=1-T47*(1-y(3));
  g1(16,28)=(-(T47*exp(y(28))*(1-y(15))));
  g1(16,29)=(-((y(16)*(1-y(3))+exp(y(28))*(1-y(15)))*(-exp(y(29)))));
  g1(17,15)=1;
  g1(17,17)=1;
  g1(18,17)=1;
  g1(18,18)=(-1);
  ...
  g1(25,25)=1;
  g1(26,26)=1;
  g1(26,28)=T47*(-exp(y(28)));
  g1(26,29)=(1-exp(y(28)))*(-exp(y(29)));
  g1(27,27)=1-(params(6)+1-params(6));
  g1(28,28)=1-(params(7)+1-params(7));
  g1(29,29)=1-(params(8)+1-params(8));
  g1(30,15)=(-(0.6666666666666666/(0.3333333333333333*(y(15)+y(15)+y(44)))));
  g1(30,30)=1;
  g1(30,44)=(-(0.3333333333333333/(0.3333333333333333*(y(15)+y(15)+y(44)))));
  g1(31,16)=(-(0.6666666666666666/(0.3333333333333333*(y(16)+y(16)+y(45)))));
  g1(31,31)=1;
  g1(31,45)=(-(0.3333333333333333/(0.3333333333333333*(y(16)+y(16)+y(45)))));
  g1(32,30)=1;
  g1(32,31)=(-1);
  g1(32,32)=1;
  g1(33,25)=(-(0.6666666666666666/(0.3333333333333333*(y(25)+y(25)+y(46)))));
  g1(33,33)=1;
  g1(33,46)=(-(0.3333333333333333/(0.3333333333333333*(y(25)+y(25)+y(46)))));
  g1(34,26)=(-(2/(y(26)+y(26)+y(47))));
  g1(34,34)=1;
  g1(34,47)=(-(1/(y(26)+y(26)+y(47))));
  g1(35,29)=(-((exp(y(29))+exp(y(29)))/(exp(y(29))+exp(y(29))+exp(y(48)))));
  g1(35,35)=1;
  g1(35,48)=(-(exp(y(48))/(exp(y(29))+exp(y(29))+exp(y(48)))));
  g1(36,8)=(-(2/(y(8)+y(8)+y(49))));
  g1(36,36)=1;
  g1(36,49)=(-(1/(y(8)+y(8)+y(49))));
  g1(37,37)=1;
  g1(37,51)=(-1);
  g1(38,38)=1;
  g1(38,53)=(-1);
