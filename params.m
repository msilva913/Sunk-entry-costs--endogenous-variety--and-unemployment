...
function [ ...
    beta, eta_L, tau, delta, ...                % predetermined parameters
    f_ss, q_ss, N_ss, w_ss, ls_ss, ...          % Target steady-state values
    sigma, b_ratio, xi_inv, x_v, epsi, ...      % Estimated parameters
...
delta      = 1-(1-0.10)^(1/12);   % Product destruction rate (set to 10% annual)
...
sigma       = 1.5;      % Inverse of intertemporal elast. of sub. (log utility)
